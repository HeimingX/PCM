...
SP_NAME=_1infer_cosClsfr
SAVE_SP=_1infer_clsName_pn75_cosClsfr

GPU=2,0

NLAB=10
PROB_TOPK=5
#python ./code/uda_with_probing_words_1vsall_cos.py --gpu $GPU --n-labeled $NLAB --add-cls-sep --cos_clsifer \
...
SAVE_SP=_1infer_clsName_pn10_cosClsfr
NLAB=3
PROB_NUM=10
#python ./code/uda_with_probing_words_1vsall_cos.py --gpu $GPU --n-labeled $NLAB --add-cls-sep --cos_clsifer \
#	--data-path $DATASET --batch-size $LBS --batch-size-u $UBS --prob_file_name $PROB_FILE_NAME \
