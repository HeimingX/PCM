...
SP_NAME=_noNormalClsfr_ce
SAVE_SP=_noNormalClsfr_ce

GPU=0,1
NLAB=10
PROB_TOPK=5
python ./code/ab_no_normal_clsfr_update_prob_words.py --gpu $GPU --n-labeled $NLAB --add-cls-sep \
	...
	--lrmain $LR_MAIN --lrlast $LR_LAST --epochs 20 --val-iteration 1000 --specific_name $SP_NAME --prob_save_sp $SAVE_SP --local_machine #--resume ./experiments/uda_probing_words/ #--eval
