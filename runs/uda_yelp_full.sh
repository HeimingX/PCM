...
T=1
DATASET=./data/yelp_review_full_csv/
...
#	--lrmain 0.000005 --lrlast 0.0005 --epochs 20 --val-iteration 1000 --specific_name $SP_NAME --eval --resume ./experiments/uda/yelp5_10/ckpt/best.nU5000_wClsSep_wGap_lr5e-06_0.0005_ep20_it1000_lbs4_ubs8_noTsa_wu1.0_T0.5_confid0.95_seed0_gapFeaOnly.ckpt
#yelp2_10/ckpt/best.nU5000_wClsSep_wGap_lr5e-06_0.0005_ep20_it1000_lbs4_ubs8_noTsa_wu1.0_T1.0_confid0.95_seed0_gapFeaOnly.ckpt
...
#GPU=1,2
BEST_ACC=0.4831
PROB_FILE_NAME=uda_nlab10_top5.0_noStopWords_probWrods_ep3.npy
PROB_TOPK=5
PROB_NUM=20 #25 #50
T=1 #.3 #0.5 #0.5 #1 #2
CONFID=0.95 #0.99 #8 #9 #5 #9 #5 #9
PROB_CONFID=0.9 #91 #9 #92 #7 #3 #4 #3 #75 #8 #7 #8 #1
WU=1 #0.5
WUP=1

SP_NAME=_onlyMatchClsfr #_rerun #7 #6 # 5 #4 #3 #2 #1 #_gtVerify
SAVE_SP=_new #2 #1
