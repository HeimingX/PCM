...
#NLAB=10
#python ./code/uda.py --gpu $GPU --n-labeled $NLAB --add-cls-sep --seed_l $SEED_L \
#	--data-path $DATASET --batch-size $LBS --batch-size-u $UBS \
#	--lambda-u 1 --T $T --confid $CONFID \
#	--lrmain $LR_MAIN --lrlast $LR_LAST --epochs 20 --val-iteration 1000 --specific_name _gapFeaOnly #--eval --resume ./experiments/uda/
#NLAB=5
#python ./code/uda.py --gpu $GPU --n-labeled $NLAB --add-cls-sep --seed_l $SEED_L \
#	--data-path $DATASET --batch-size $LBS --batch-size-u $UBS \
#	--lambda-u 1 --T $T --confid $CONFID \
...
SP_NAME=_1infer
SAVE_SP=_1infer_clsName_seed1

GPU=2
NLAB=10
PROB_TOPK=5
python ./code/uda_with_probing_words_1vsall.py --gpu $GPU --n-labeled $NLAB --add-cls-sep --seed_l $SEED_L \
